...
/**
 * Shorthand for s(anitis)e_str(ing)
 *
 * @param string $value string to be made safe for comparison/interpolation to string
 * @return string result of sanitation
 */
...
/**
 * Shorthand for s(anitis)e_Int(eger)
 *
 * @param string $value string to be made safe for comparison/interpolation to int
 * @return int result of sanitation
 */
function s6eInt($value)
{
  return filter_var(trim(htmlspecialchars($value)), FILTER_SANITIZE_NUMBER_INT);
}
